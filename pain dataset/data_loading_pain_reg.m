...
y_train=zeros(divide_train*no_class,1);
% class 1 
X_train(1:divide_train,1:no_feat)=class1(1:divide_train,:);
y_train(1:divide_train,1)=0;
...
y_train(divide_train*2+1:divide_train*3,1)=2;
...
y_test(divide_test*2+1:divide_test*3,1)=2;
...
y_test(divide_test*3+1:divide_test*4,1)=3;



% class 5 
X_test(divide_test*4+1:divide_test*5,1:no_feat)=class5(divide_train+1:no_sub,:);
y_test(divide_test*4+1:divide_test*5,1)=4;
